...
fn tokenize_line<'a>(line_of_code :String, token_rules : &'a Vec<token::TokenRules>) -> Result<Vec<token::Token<'a>>,token::TokenError>
{
...
{
    let token_rules = vec![token::TokenRules{
